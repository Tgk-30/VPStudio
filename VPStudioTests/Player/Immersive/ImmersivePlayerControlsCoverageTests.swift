...
struct ImmersivePlayerControlsCoverageTests {
    ...
    func controlsSourcePostsEveryExpectedImmersiveNotification() throws {
        ...
        #expect(source.contains("@State private var isScrubberHovered"))
        ...
        #expect(source.contains("Text(\"Exit\")"))
        #expect(source.contains(".background(.red.opacity(0.55), in: Capsule())"))
